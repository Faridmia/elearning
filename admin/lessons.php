					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							...
							<?php if(isset($_GET['lessonid'])) { 
								...
								$data        = array('lesson_id','lesson_title','course_id','section_id','video_url');
									...
									<div class="dashboard_container">
										...
										<div class="dashboard_container_body">
											...
											<?php
												$database    = new Database();
												$conn        = $database->connection;
												$data        = array('lesson_title','section_id','video_url','lesson_id','course_id');
												$query       = $database->getData("lesson",$data); ?>
