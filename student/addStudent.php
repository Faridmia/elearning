...
if ( !isset( $_SESSION['is_login'] ) ) {
    ...
    if ( isset( $_POST['checkLogemail'] ) && isset( $_POST['user_email'] ) && isset( $_POST['user_pass'] ) ) {
        ...
        $sql    = "SELECT email,password,users_id FROM users WHERE email = '$user_email' AND password = '$hashpass'";
        $result = $conn->query( $sql );
    ...
    if ( isset( $_POST['checkLogemail_enroll'] ) && isset( $_POST['user_email'] ) && isset( $_POST['user_pass'] ) ) {
