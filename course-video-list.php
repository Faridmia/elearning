									...
									<div id="collapseOne<?php echo $i; ?>" aria-labelledby="headingOne<?php echo $i; ?>" data-parent="#accordionExample" class="collapse <?php echo $active; ?>">
										<div class="card-body pl-3 pr-3">
											...
											$sqllesson = "SELECT lesson.lesson_id ,lesson.lesson_title,lesson.course_id,lesson.section_id,lesson.video_url,section.section_id ,section.section_title,section.course_id
												FROM lesson
												INNER JOIN section ON lesson.section_id = section.section_id WHERE lesson.course_id = {$course_id}";
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="ed_view_box style_2">
						...
						<div class="ed_view_link">
							<?php
							if (isset($_SESSION['is_login'])) { ?>
								<a href="course-video-play.php?courseid=<?php echo $course_id;?>" class="btn btn-theme enroll-btn btn-enroll-button-now" onclick="handleEnrolledButton()">Start Course<i class="ti-angle-right"></i></a>
							<?php } else { ?>
								<a href="#" class="btn btn-theme enroll-btn" data-toggle="modal" data-target="#login">Get Enrolled<i class="ti-angle-right"></i></a>
							<?php } ?>
						</div>
