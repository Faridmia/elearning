													...
													<div class="col-sm-12">
														<select name="course_name" class="form-control p_category">
															...
															$usersql = "SELECT * FROM users where email = '$user_login'";
																...
																$users_id = $userfetch['users_id'];
															$sql2         = "SELECT * FROM courses WHERE status = 1 AND users_id = '$users_id'";
															$querycourse2 = mysqli_query($conn, $sql2);
															while ($row = mysqli_fetch_array($querycourse2)) {
																$course_id    = (int) $row['course_id'];
																$course_title = $row['course_title'];
												...
												<div class="form-group col-md-12">
													...
													<div class="col-sm-12">
														<select name="section_name" class="form-control p_category">
															...
															while ($c_row = mysqli_fetch_array($querycourse2)) {
							...
							<div class="dashboard_container">
								...
								<div class="dashboard_container_body">
									<div class="table-responsive">
										...
										$users_id = $userfetch['users_id'];
										$sql2         = "SELECT * FROM courses WHERE status = 1 AND users_id = '$users_id'";
										$querytwo = mysqli_query($conn, $sql2);
										...
										<table class="table table-striped">
											...
											<tbody>
												...
												while ($course_data = mysqli_fetch_array($querytwo)) {
													...
													$data  = array('lesson_title', 'section_id', 'video_url', 'lesson_id', 'upload_video');
													$query = $database->getData("lesson", $data, 'course_id', '=', $course_id_db);
												...
												if ($numrows > 0) {
													...
													while ($row = mysqli_fetch_array($query)) {
														...
														echo "<td>$upload_video</td>";
														echo "<td>
																<div class='dash_action_link'>
																	<a href='lessions.php?lessonid=$lesson_id&name=lesson' class='view'>View</a>
