										...
										<div class="submit-section">
											<div class="form-row">
												...
												<div class="form-group col-md-6 form-check">
													<input type="checkbox" class="form-check-input" <?php if ($is_free_course == 1) {
												...
												<div class="form-group col-md-6 form-check">
													<input type="checkbox" class="form-check-input" <?php if ($is_featured_course == 1) {
																										echo "checked='checked'";
																									}
																									?> name="is_free_course" id="is_free_course">
													<label class="form-check-label">Check if this course is Free?</label>
									...
									<div class="dashboard_container_body p-4">
										...
										<div class="submit-section">
											<div class="form-row">
												...
												<div class="form-group col-md-6">
													<input type="checkbox" class="form-check-input" <?php if ($is_top_course == 1) {
																										echo "checked = 'checked'";
																									}
																									?> name="is_top_course" id="is_top_course">
